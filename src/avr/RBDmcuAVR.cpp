...
volatile uint16_t dimZCPin[ALL_DIMMERS]; //add mod for XOD without effect in AVR
	...
	
{
	...
	toggle_state = false;
	dimZCPin[current_dim-1] = zc_dimmer_pin; //add mod for XOD without effect in AVR
